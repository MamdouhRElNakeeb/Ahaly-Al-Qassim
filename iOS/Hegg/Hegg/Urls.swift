...
//  Hegg
//
//  Created by Mamdouh El Nakeeb on 11/3/17.
...
class Urls {
    ...
    static let baseURL = "http://osamafayez.com/Hegg/qassim/"
    ...
    static let youtubePLid = "PLULt7R-fsx1GzIHTj3yaHwaL5WRwcGdr7&"
    ...
    static let tayeh = baseURL + "tayeh.php"
