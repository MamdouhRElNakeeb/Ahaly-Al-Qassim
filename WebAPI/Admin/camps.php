...
$result = $access->getTableContent("camp_locations");
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Camps Locations</a>
                </div>
                <!--
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="green">
                                <h4 class="title">موقعنا بالمشاعر</h4>
                                <p class="category">موقع شركة أهالي القصيم بالمشاعر</p>
                            </div>
                            <div class="card-content table-responsive">
                                <table class="table">
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        ?>
                                        <tr>
                                            <td><a href="http://maps.google.com/maps?q=loc:<?php echo $row["latitude"]; echo ","; echo $row["longitude"];?>" target="_blank"><?php echo $row["latitude"]; echo ","; echo $row["longitude"];?></a></td>
