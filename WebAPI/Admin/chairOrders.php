...
$result = $access->getTableContent("chair_orders");
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Chair Order</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="green">
                                <h4 class="title">طلب كرسي</h4>
                                <p class="category">طلبات الحجاج للكراسى</p>
                            </div>
                            <div class="card-content table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-primary"><?php echo $row["chairs_no"]; ?></td>
