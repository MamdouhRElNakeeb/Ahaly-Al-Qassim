...
$result = $access->getTableContent("gather_locations");
...
<head>
    ...
    <title>Gathering Locations</title>
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Gathering Locations</a>
                </div>
                <!--
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="green">
                                <h4 class="title">أماكن التجمع</h4>
                                <p class="category">أماكن تجمع الحجاج</p>
                            </div>
